...
public interface Pcl4Visitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link Pcl4Parser#caseBranch}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCaseBranch(Pcl4Parser.CaseBranchContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link Pcl4Parser#rangeExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitRangeExpression(Pcl4Parser.RangeExpressionContext ctx);
	/**
